...
pb:value("17:225:0882", translate("225M (S3+ default)"))
pb:value("18:218.75:1106", translate("219M (S3 default)")) 
...
pb:value("38:100:0783", translate("100M"))
  
pb = conf:taboption("advanced", Value, "voltage", translate("voltage"),"Modify Voltage, Click Save &#38; Apply, and then re-power the miner.")
pb.default = "0000"
return m
